...
You can add a tabs page block to a page by clicking on the btn:[Add] button and selecting Tabs from the list of available page blocks.

To tab a page block, select the desired page block from the list of available page blocks.
