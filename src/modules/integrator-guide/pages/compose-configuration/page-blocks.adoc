...
{
  "image": {
    "rel": "compose-configuration/config-tabs-add-button.png",
...
|
Determines the title of the tab. If not set, the title of the page block is used, and if that is unset, a generic name is used which is based on the kind of the page block.

| [#page-block-tabs-edit]#<<page-block-tabs-edit,Edit>>#
|
Allows you to access the configurator of a tabbed block.

| [#page-block-tabs-plus]#<<page-block-tabs-plus,Add Block>>#
|
Allows you to add a new block that is immediately tabbed. Access this configuration by clicking on the btn:[+] button.
...
[NOTE]
====
When you delete a tabs block, the number of times its blocks occur in other tabs blocks will be computed, and this will determine if the blocks it held will be added to the main page or not based on the result of that computation.
====
