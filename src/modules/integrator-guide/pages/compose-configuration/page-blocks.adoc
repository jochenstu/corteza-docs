...
The *tabs page block* allows you to group different page blocks together and display them as tabs.
...
In the *tabs* tab, you can configure the tabs page block in other to add the desired page blocks to it or refine the appearance of the tabs page block itself.

To add a page block to the tabs page block, click on the *+ Add* button and select the desired page block from the list of available page blocks.
  ...
  "annotations": [
    {
      ...
      "w": 75,
      "h": 30,
      "text": "Tabs page block configurator"
    },
    {
      "x": 938,
      "y": 415,
...
Tabbing a block removes it from the main page and adds it to the tabs page block.
...
A tabbed block is removed from the main page, but you can access its configuration via the *edit* button corresponding to it in the tabs page block's configurator.
...
Before selecting a page block to be tabbed, you will find an input box, this controls what is going to be displayed as the title of the tab. 
If not set, the title of the page block is used, and if that is unset, a generic name is used which is based on the *kind* of the block.
// annotate here
...
If you are no longer interested in a tabbed block, you can remove it from the tabs page block by clicking on the *trash icon* button corresponding to it in the tabs page block's configurator.
// annotate here
