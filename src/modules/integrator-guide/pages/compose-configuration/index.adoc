...
Page blocks can be duplicated, whi bnch makes it a breeze to reuse a page block.
...
Suppose you have some content that you would need on a separate page, and you want to skip the process of recreating it, you can simply copy the content page block which you would be using in this case, and paste it on the page you want. 
...
You can then navigate to any other page to reuse this page block as many times as you want by pasting it, just as you would any other content on your clipboard.
